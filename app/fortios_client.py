...
class FortiOSClient:
    ...
    def __init__(self, url: str, token: str, vdom: str = "root", verify_ssl: bool = False):
        """
    ...
    def _make_request(self, method: str, endpoint: str, data: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        try:
            if method.upper() == 'GET':
                ...
                response = self.session.post(url, params=params, json=data, verify=self.verify_ssl)
            elif method.upper() == 'PUT':
                response = self.session.put(url, params=params, json=data, verify=self.verify_ssl)
            ...
            try:
                ...
                result = {"status": "error", "message": "Invalid JSON response", "raw_response": response.text}
